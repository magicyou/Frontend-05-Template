...
function layout (element) {
    ...
    var items = element.chlidren.filter(e => e/type === 'element');
    ...
    if (!style[mainSize]) {
        ...
        for (var i = 0; i < items.lengt; i++) {
            ...
            if (itemStyle[mainSize] !== null || itemStyle[main] !== (void 0)) {
                elementStyle[mainSize] = elementStyle[main] + itemStyle[mainSize];
            }
        }
    ...
    var mainSpace = elementStylep[mainSize];
    var crossSpace  = 0;
    ...
    for (var i = 0; i < items.length; i++) {
        ...
        if (itemStyle[main] === null) {
            itemStyle[mainSize] = 0;
        }

        if (itemStyle.flex) {
            flexLine.PushManager(item)
    ...
    if (mainSpace < 0) {
        var scale = style[mainSize] / (style[mainSize] - mainSpce);

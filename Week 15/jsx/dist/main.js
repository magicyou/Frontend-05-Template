...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animation.js */ \"./animation.js\");\n\nvar tl = new _animation_js__WEBPACK_IMPORTED_MODULE_0__.TimeLine();\ntl.start();\ntl.add(new _animation_js__WEBPACK_IMPORTED_MODULE_0__.Animation(document.querySelector('#el').getElementsByClassName, 'transform', 0, 500, 2000, 0, null, function (v) {\n  return \"translate(\".concat(v, \"px)\");\n}));\ndocument.querySelector('#appuse_btn').addEventListener('click', function () {\n  return tl.pause();\n});\ndocument.querySelector('#resume_btn').addEventListener('click', function () {\n  return tl.resume();\n});\n\n//# sourceURL=webpack://jsx/./animation-demo.js?");
